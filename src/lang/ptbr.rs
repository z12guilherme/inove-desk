...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do inove desk..."),
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "Suporte Remoto Oficial - Rede DMI"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o inove desk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [inove desk Input]."),
        ...
        ("Send clipboard keystrokes", "Enviar comandos da área de transferência"),
